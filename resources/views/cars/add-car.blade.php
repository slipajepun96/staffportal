...
{
    document.getElementById(divId).style.display = element.value == 1 ? 'inline-block' : 'none';
}
...
<div class="m-3">
    ...
    <div>
        <div class="mb-4 mx-1 inline-block md:w-1/6 w-full ">
         ...
         <select name="official_car" class="shadow appearance-none border w-1/4 w-full rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline " onchange="showDiv('hidden_div', this)">
