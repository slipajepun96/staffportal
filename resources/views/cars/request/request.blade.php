...
<div class="m-3">
    <form action="{{route('cars-request-request-add')}}" method="POST">
        @csrf
        ...
        <div>
            ...
            <div class="mb-4 mx-1 inline-block md:w-1/4 w-full ">
                <label class="block text-gray-700 text-sm font-bold mb-2" for="name">
                Tarikh & Masa Bermula & Berakhir (Perancangan)
                </label>                 
                ...
                @error('chassis_no')
                    <span class="text-sm text-red"> {{$message}}</span>
                @enderror
                <input type="hidden" name="planned_start_datetime" id="planned_start_datetime"  class="shadow appearance-none border w-1/4 w-full rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ">    
                <input type="hidden" name="planned_end_datetime" id="planned_end_datetime"  class="shadow appearance-none border w-1/4 w-full rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ">    
            </div>
            <div class="mb-4 mx-1 inline-block md:w-1/4 w-full ">    
                <label class="block text-gray-700 text-sm font-bold mb-2" for="name">
                Tujuan
