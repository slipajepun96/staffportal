            ...
            ?>
                ...
                <td class="border border-gray-300 p-3 px-5">
                                                            @if($car_request->status=='1') 
                                                               <div class="text-black-700 text-sm bg-yellow-400 rounded-full p-2">Belum Diluluskan</div>
                                                            @elseif($car_request->status=='2')
                                                            <div class="text-white bg-green-400 text-sm rounded-full p-2">Diluluskan</div>
                                                            @elseif($car_request->status=='3')
                                                            <div class="text-white bg-red-400 text-sm rounded-full p-2">Ditolak</div>
                                                            @else   
                                                            <div class="text-white bg-black text-sm rounded-full p-2">Tiada Status</div>
                                                            @endif
                </td>
                ...
                <td class="border border-gray-300 p-3 px-5">
                        ...
                        </a><?php $current_time=date("Y-m-d H:i:s");?>
                        @if($current_time<$car_request->planned_start_datetime)
                        <a href="">
                            <button class="bg-red-500 hover:bg-red-300 text-gray-800 font-bold py-2 px-4 rounded" onclick="deactivateConfirmation()"> 
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
